...
QDEF(MP_QSTR_ULPDeepSleep, (const byte*)"\x17\x7e\x0c" "ULPDeepSleep")
...
QDEF(MP_QSTR_countPulses, (const byte*)"\x6a\x6d\x0b" "countPulses")
...
QDEF(MP_QSTR_deiniti2s, (const byte*)"\xb6\x6c\x09" "deiniti2s")
...
QDEF(MP_QSTR_espnow, (const byte*)"\x15\x8a\x06" "espnow")
...
QDEF(MP_QSTR_initULP, (const byte*)"\x36\xc1\x07" "initULP")
QDEF(MP_QSTR_initi2s, (const byte*)"\x97\x76\x07" "initi2s")
...
QDEF(MP_QSTR_isrecording, (const byte*)"\x32\xb3\x0b" "isrecording")
...
QDEF(MP_QSTR_mic, (const byte*)"\xa2\x42\x03" "mic")
QDEF(MP_QSTR_micgain, (const byte*)"\x23\x45\x07" "micgain")
...
QDEF(MP_QSTR_musichead, (const byte*)"\x2c\x44\x09" "musichead")
QDEF(MP_QSTR_mymodule, (const byte*)"\x4b\xc8\x08" "mymodule")
...
QDEF(MP_QSTR_record, (const byte*)"\x28\x73\x06" "record")
...
QDEF(MP_QSTR_setSamplerate, (const byte*)"\x03\x3a\x0d" "setSamplerate")
...
QDEF(MP_QSTR_wifistop, (const byte*)"\xac\x1c\x08" "wifistop")
